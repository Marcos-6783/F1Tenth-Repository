...
# ============================================================
# gap_node.py — Follow the Gap (Versión Optimizada Oschersleben)
#
...
class ReactiveFollowGap(Node):
    def __init__(self):
        ...
        self.get_logger().info("¡Nodo ReactiveFollowGap optimizado iniciado correctamente!")
        ...
        self.alpha_suavizado = 0.50           # Peso del ángulo nuevo (0.35 nuevo, 0.65 anterior)
    ...
    def lidar_callback(self, data):
        ...
        # Interpola de forma fluida basándose en la severidad real del giro para evitar subvirajes abruptos
